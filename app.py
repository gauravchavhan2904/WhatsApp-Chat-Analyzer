...
#     with open("back.jpg", "rb") as image_file:
...
#             margin-top: 0rem !important;   /* Optional: reduce margin */
#         }}
...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        with col1:
            ...
            ax.yaxis.set_major_locator(MaxNLocator(integer=True))  # Ensure only integer ticks on y-axis
            plt.xticks(rotation='vertical')
            st.pyplot(fig)   
